---
layout: post
title: "HPE Compute Scale-up Server Web-UI"
...
excerpt: This hands on lab lets you navigate in the Web UI of an HPE Compute Scale-Up Server simulator.
---

Living Lab experience

# HPE Compute Scale-Up Server Web UI

This lab introduces TBD.
There is a small-space directive below this line.
{: .small-space}
There is a small-space directive above this line.
Need to test the following link into an external link: [HPECOMCmdlets](https://www.powershellgallery.com/packages/HPECOMCmdlets)

TBD

<a href="https://www.powershellgallery.com/packages/HPECOMCmdlets" target="_blank">HPECOMCmdlets</a>.
