...
2. A `CMD.exe` terminal is started, launching two Python windows and the defautl browser pointing the CSUS simulator:
    ...
    [![]( {{ site.baseurl }}/assets/images/HOLs/CSUS3200-Web-UI/6-StartingSimulator.png){: .bordered-image-thin}]( {{ site.baseurl }}/assets/images/HOLs/CSUS3200-Web-UI/6-StartingSimulator.png){:class="img-500"}{: data-lightbox="gallery"}
